...
<?php $component->withAttributes([]); ?>
    ...
    <div id="speedDialActions" class="speed-dial-actions">
        <a href="<?php echo e(route('courses.create')); ?>" class="speed-dial-item" style="text-decoration: none;">
            <span class="speed-dial-label">Crear Curso</span>
            <div class="speed-dial-button" style="background: white; color: var(--theme-color);">
                <i class="fas fa-book"></i>
            </div>
        </a>
        <a href="<?php echo e(route('students.create')); ?>" class="speed-dial-item" style="text-decoration: none;">
            <span class="speed-dial-label">Añadir Estudiante</span>
            <div class="speed-dial-button" style="background: white; color: var(--theme-color);">
                <i class="fas fa-user-plus"></i>
            </div>
        </a>
        <a href="<?php echo e(route('attendance.create')); ?>" class="speed-dial-item" style="text-decoration: none;">
        ...
        <a href="<?php echo e(route('grades.index')); ?>" class="speed-dial-item" style="text-decoration: none;">
            <span class="speed-dial-label">Registrar Notas</span>
            <div class="speed-dial-button">
                <i class="fas fa-star"></i>
            </div>
        </a>
        <a href="<?php echo e(route('dashboard')); ?>" class="speed-dial-item" style="text-decoration: none;">
            <span class="speed-dial-label">Ver Reportes</span>
            <div class="speed-dial-button">
                <i class="fas fa-chart-line"></i>
            </div>
        </a>
        <a href="<?php echo e(route('settings.index')); ?>" class="speed-dial-item" style="text-decoration: none;">
