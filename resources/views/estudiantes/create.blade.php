<x-app-layout>
    ...
    <div class="card" style="max-width: 1000px; margin: 0 auto;">
        ...
        <div style="margin-bottom: var(--spacing-2xl); text-align: center;">
            ...
            <p style="color: var(--gray-600); font-size: 1rem;">Complete el formulario para añadir un nuevo estudiante
                al sistema.</p>
        </div>
        ...
        <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data" id="studentForm">
                ...
                <div class="grid grid-cols-3" style="gap: var(--spacing-lg); margin-bottom: var(--spacing-lg);">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="nacionalidad" class="form-input"
                            value="{{ old('nacionalidad', 'Chilena') }}" placeholder="Ej. Chilena">
                        @error('nacionalidad')
                            <span
                                style="color: #ef4444; font-size: 0.875rem; margin-top: 0.25rem; display: block;">{{ $message }}</span>
                        @enderror
                ...
                <div class="grid grid-cols-2" style="gap: var(--spacing-lg); margin-bottom: var(--spacing-lg);">
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="apoderado_rut" id="apoderado_rut" class="form-input"
                            value="{{ old('apoderado_rut') }}" required placeholder="12345678-9" maxlength="12">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <select name="apoderado_relacion" class="form-select" required>
                            <option value="">Seleccione...</option>
                            <option value="Padre" {{ old('apoderado_relacion') == 'Padre' ? 'selected' : '' }}>Padre
                            </option>
                            <option value="Madre" {{ old('apoderado_relacion') == 'Madre' ? 'selected' : '' }}>Madre
                            </option>
                            <option value="Tutor" {{ old('apoderado_relacion') == 'Tutor' ? 'selected' : '' }}>Tutor
                            </option>
                            <option value="Abuelo/a" {{ old('apoderado_relacion') == 'Abuelo/a' ? 'selected' : '' }}>
                                Abuelo/a</option>
                            <option value="Tío/a" {{ old('apoderado_relacion') == 'Tío/a' ? 'selected' : '' }}>Tío/a
                            </option>
                ...
                <div class="grid grid-cols-2" style="gap: var(--spacing-lg); margin-bottom: var(--spacing-lg);">
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="apoderado_nombre" class="form-input"
                            value="{{ old('apoderado_nombre') }}" required placeholder="Ej. María">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="apoderado_apellido" class="form-input"
                            value="{{ old('apoderado_apellido') }}" required placeholder="Ej. González">
                ...
                <div class="grid grid-cols-2" style="gap: var(--spacing-lg); margin-bottom: var(--spacing-lg);">
                    <div class="form-group mb-0">
                        ...
                        <input type="email" name="apoderado_email" class="form-input"
                            value="{{ old('apoderado_email') }}" placeholder="apoderado@email.com">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="apoderado_telefono" class="form-input"
                            value="{{ old('apoderado_telefono') }}" placeholder="+56 9 1234 5678">
                ...
                <div class="grid grid-cols-2" style="gap: var(--spacing-lg); margin-bottom: var(--spacing-lg);">
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="apoderado_telefono_emergencia" class="form-input"
                            value="{{ old('apoderado_telefono_emergencia') }}" placeholder="+56 9 8765 4321">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="apoderado_ocupacion" class="form-input"
                            value="{{ old('apoderado_ocupacion') }}" placeholder="Ej. Ingeniero">
                ...
                <div class="grid grid-cols-2" style="gap: var(--spacing-lg);">
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="apoderado_lugar_trabajo" class="form-input"
                            value="{{ old('apoderado_lugar_trabajo') }}" placeholder="Ej. Empresa XYZ">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <input type="text" name="apoderado_direccion" class="form-input"
                            value="{{ old('apoderado_direccion') }}" placeholder="Calle, número, comuna">
            ...
            <!-- Sección: Inscripción a Curso -->
            <div style="margin-bottom: var(--spacing-2xl);">
                <div
                    style="display: flex; align-items: center; gap: var(--spacing-sm); margin-bottom: var(--spacing-lg); padding-bottom: var(--spacing-md); border-bottom: 2px solid var(--gray-200);">
                    <i class="fas fa-school" style="color: var(--theme-color); font-size: 1.25rem;"></i>
                    <h3 style="font-size: 1.125rem; font-weight: 700; color: var(--gray-900); margin: 0;">Inscripción a
                        Curso</h3>
                </div>
                ...
                <div class="form-group mb-0">
                    ...
                    <small style="color: var(--gray-600); font-size: 0.875rem; margin-top: 0.25rem; display: block;">
                        Puede asignar el estudiante a un curso ahora o hacerlo más tarde.
                    </small>
                    @error('curso_id')
                        <span
                            style="color: #ef4444; font-size: 0.875rem; margin-top: 0.25rem; display: block;">{{ $message }}</span>
            ...
            <div class="action-buttons"
                ...
                <a href="{{ route('students.index') }}" class="btn btn-ghost" style="min-width: 120px;">
            ...
            documentoDiv.innerHTML = `
                <div class="grid grid-cols-2" style="gap: var(--spacing-lg); margin-bottom: var(--spacing-md);">
                    <div class="form-group mb-0">
                        ...
                        <select name="documentos[${documentoIndex}][tipo]" class="form-select" required>
                    ...
                    <div class="form-group mb-0">
                        ...
                        <input type="file" name="documentos[${documentoIndex}][archivo]" class="form-input" accept=".pdf,.jpg,.jpeg,.png" required>
                    </div>
                </div>
