<x-app-layout>
    ...
    <div class="mb-xl filters-card">
        <div class="grid" style="grid-template-columns: 2fr 1fr 1fr; gap: var(--spacing-md); align-items: center;">
            <div class="form-group mb-0" style="position: relative;">
                ...
                <input type="text" id="searchInput" class="form-input" placeholder="Buscar estudiantes..."
        ...
        <div class="filters-modal-content" onclick="event.stopPropagation()">
            ...
            <div class="filters-modal-body">
                <div class="form-group">
                    ...
                    <input type="text" id="searchInputMobile" class="form-input" placeholder="Buscar estudiantes..."
        ...
        <div class="mobile-table-container"
            ...
            @forelse($estudiantes as $estudiante)
                <div class="estudiante-item mobile-table-row"
                    ...
                    data-curso="{{ $estudiante->curso_actual->id ?? '' }}" data-estado="{{ $estudiante->estado }}">

                    <div style="display: flex; align-items: center; gap: var(--spacing-sm);">
                        <div
                            style="width: 36px; height: 36px; border-radius: 50%; background: #84cc16; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 0.75rem; flex-shrink: 0;">
                        ...
                        <div style="display: flex; gap: 4px; flex-shrink: 0;" onclick="event.stopPropagation();">
                            ...
                            <form action="{{ route('students.destroy', $estudiante->id) }}" method="POST" style="margin: 0;"
    ...
    <div class="table-container">
        <table class="table">
            ...
            <tbody>
                @forelse($estudiantes as $estudiante)
                    <tr class="estudiante-item" style="cursor: pointer;"
                        onclick="window.location='{{ route('students.show', $estudiante->id) }}'"
                        data-search="{{ strtolower($estudiante->nombre . ' ' . $estudiante->apellido . ' ' . $estudiante->rut) }}"
                        data-curso="{{ $estudiante->curso_actual->id ?? '' }}" data-estado="{{ $estudiante->estado }}">
                        <td>
                        ...
                        <td>
                            @if($estudiante->curso_actual)
                                <span
                                    style="display: inline-block; padding: 0.25rem 0.625rem; font-size: 0.6875rem; font-weight: 700; letter-spacing: 0.05em; color: #84cc16; background: rgba(132, 204, 22, 0.1); border-radius: 9999px;">{{ $estudiante->curso_actual->nombre }}</span>
                            @else
                                <span
                                    style="display: inline-block; padding: 0.25rem 0.625rem; font-size: 0.6875rem; font-weight: 600; color: var(--gray-500); background: var(--gray-100); border-radius: 9999px;">Sin
                                    curso</span>
                            @endif
                        </td>
                        <td>
                        ...
                        <td>
                            @if($estudiante->estado === 'activo')
                                <span
                                    style="display: inline-block; padding: 0.25rem 0.625rem; font-size: 0.6875rem; font-weight: 700; letter-spacing: 0.05em; color: var(--success); background: rgba(34, 197, 94, 0.1); border-radius: 9999px;">Activo</span>
                            @elseif($estudiante->estado === 'inactivo')
                                <span
                                    style="display: inline-block; padding: 0.25rem 0.625rem; font-size: 0.6875rem; font-weight: 700; letter-spacing: 0.05em; color: var(--warning); background: rgba(245, 158, 11, 0.1); border-radius: 9999px;">Inactivo</span>
                            @else
                                <span
                                    style="display: inline-block; padding: 0.25rem 0.625rem; font-size: 0.6875rem; font-weight: 600; color: var(--gray-500); background: var(--gray-100); border-radius: 9999px;">{{ ucfirst($estudiante->estado) }}</span>
                            @endif
                        </td>
                        <td>
    ...
    <div id="noResults" class="card mb-xl" style="display: none;">
        <div class="card-body text-center" style="padding: var(--spacing-2xl);">
            ...
            <p style="color: var(--gray-600); margin: 0;">No se encontraron estudiantes que coincidan con tu búsqueda
            </p>
        </div>
    </div>
