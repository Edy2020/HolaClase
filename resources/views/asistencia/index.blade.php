<x-app-layout>
    ...
    <div id="filterModal" class="filter-modal" onclick="if(event.target === this) closeFilterModal()">
        <div class="filter-modal-content">
            ...
            <form method="GET" action="{{ route('attendance.index') }}" id="mobileFilterForm" style="padding: var(--spacing-lg);">
                <!-- Curso Filter -->
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="date" name="fecha_desde" id="mobileFechaDesde" class="form-control" value="{{ request('fecha_desde') }}"
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="date" name="fecha_hasta" id="mobileFechaHasta" class="form-control" value="{{ request('fecha_hasta') }}"
                            style="padding-left: 40px; border: 2px solid var(--gray-200); border-radius: var(--radius-lg); transition: all 0.2s; font-size: 0.9375rem;"
                            onfocus="this.style.borderColor='var(--theme-color)'; this.style.boxShadow='0 0 0 3px rgba(139, 92, 246, 0.1)'"
                            onblur="this.style.borderColor='var(--gray-200)'; this.style.boxShadow='none'">
                    </div>
