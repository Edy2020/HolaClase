    ...
    <div class="grid grid-cols-2" style="gap: var(--spacing-xl);">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endphp
                <div
                    style="text-align: center; padding: var(--spacing-2xl); background: {{ $c['bg'] }}; border: 2px solid {{ $c['border'] }}; border-radius: var(--radius-xl);">
                    <i class="fas {{ $c['icon'] }}"
                        style="font-size: 3.5rem; color: {{ $c['text'] }}; margin-bottom: var(--spacing-md);"></i>
                    <div style="font-size: 2rem; font-weight: 800; color: {{ $c['text'] }};">
                ...
                <div style="display: flex; gap: var(--spacing-md); margin-top: var(--spacing-lg);">
                    <div
                        style="flex: 1; text-align: center; padding: var(--spacing-md); background: var(--gray-50); border-radius: var(--radius-md);">
                        <div
                            style="font-size: 0.7rem; color: var(--gray-500); font-weight: 600; text-transform: uppercase; margin-bottom: 4px;">
                            Registrado</div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            Actualizado</div>
                        <div style="font-size: 0.875rem; font-weight: 600; color: var(--gray-700);">
                            {{ $asistencia->updated_at->format('d/m/Y H:i') }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div style="display: flex; align-items: center; gap: var(--spacing-md);">
                        <div
                            style="width: 52px; height: 52px; border-radius: 50%; background: linear-gradient(135deg, var(--theme-color), var(--theme-dark)); display: flex; align-items: center; justify-content: center; color: white; font-weight: 800; font-size: 1.1rem; flex-shrink: 0;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <dl style="display: grid; gap: var(--spacing-md);">
                        <div>
                            <dt
                                style="font-size: 0.7rem; font-weight: 700; color: var(--gray-400); text-transform: uppercase; margin-bottom: 2px;">
                                CURSO</dt>
                            <dd style="font-weight: 700; color: var(--gray-900); font-size: 1rem;">
                        ...
                        <div style="display: flex; gap: var(--spacing-md);">
                            <a href="{{ route('attendance.reporte.estudiante', $asistencia->estudiante_id) }}"
                                class="btn btn-outline" style="flex: 1; text-align: center; font-size: 0.8rem;">
                                <i class="fas fa-user-chart"></i> Reporte Alumno
                            </a>
                            <a href="{{ route('attendance.reporte.curso', $asistencia->curso_id) }}"
                                class="btn btn-outline" style="flex: 1; text-align: center; font-size: 0.8rem;">
