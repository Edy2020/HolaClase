<x-app-layout>
    ...
    <div class="mb-xl filters-card">
        <div class="grid" style="grid-template-columns: 2fr 1fr; gap: var(--spacing-md); align-items: center;">
            <div class="form-group mb-0" style="position: relative;">
                ...
                <input type="text" id="searchInput" class="form-input" placeholder="Buscar profesores..."
        ...
        <div class="filters-modal-content" onclick="event.stopPropagation()">
            ...
            <div class="filters-modal-body">
                <div class="form-group">
                    ...
                    <input type="text" id="searchInputMobile" class="form-input" placeholder="Buscar profesores..."
                ...
                <div class="profesor-item mobile-table-row"
                    ...
                    <div style="display: flex; align-items: center; gap: var(--spacing-sm);">
                        ...
                        <div style="display: flex; gap: 4px; flex-shrink: 0;" onclick="event.stopPropagation();">
                            ...
                            <form action="{{ route('teachers.destroy', $profesor->id) }}" method="POST" style="margin: 0;"
    ...
    <div class="table-container">
        <table class="table">
            ...
            <tbody>
                @forelse($profesores as $profesor)
                    <tr class="profesor-item" style="cursor: pointer;"
                        onclick="window.location='{{ route('teachers.show', $profesor->id) }}'" \n
                        data-search="{{ strtolower($profesor->nombre . ' ' . $profesor->apellido . ' ' . $profesor->rut) }}"
                        \n data-nivel="{{ $profesor->nivel_ensenanza ?? '' }}">
                        <td>
                        ...
                        <td>
                            @if($profesor->nivel_ensenanza)
                                <span
                                    style="display: inline-block; padding: 0.25rem 0.625rem; font-size: 0.6875rem; font-weight: 700; letter-spacing: 0.05em; color: #84cc16; background: rgba(132, 204, 22, 0.1); border-radius: 9999px;">{{ $profesor->nivel_ensenanza }}</span>
                            @else
                                <span
            ...
            <form action="{{ route('teachers.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="filters-modal-body">
                    <p style="color: var(--gray-600); margin-bottom: var(--spacing-md); font-size: 0.9375rem;">
                        Sube un archivo CSV con tus profesores. Asegúrate de incluir las siguientes columnas requeridas
                        en este orden (con encabezado):
                    </p>
                    <ul
