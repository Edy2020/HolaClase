<x-app-layout>
    ...
    <div class="card" style="max-width: 900px; margin: 0 auto;">
        ...
        <div style="margin-bottom: var(--spacing-2xl); text-align: center;">
            ...
            <p style="color: var(--gray-600); font-size: 1rem;">{{ $profesor->nombre }} {{ $profesor->apellido }}</p>
        </div>
            ...
            <div style="margin-bottom: var(--spacing-2xl);">
                ...
                @if($profesor->documentos->count() > 0)
                    <div style="margin-bottom: var(--spacing-xl);">
                        <h4 style="font-size: 0.875rem; font-weight: 600; color: var(--gray-700); margin-bottom: var(--spacing-md); text-transform: uppercase; letter-spacing: 0.05em;">
                            Documentos Actuales
                        </h4>
                        <div style="background: white; border-radius: var(--radius-md); border: 1px solid var(--gray-200);">
                            @foreach($profesor->documentos as $documento)
                                <div style="display: flex; align-items: center; justify-content: space-between; padding: var(--spacing-md); border-bottom: 1px solid var(--gray-200); {{ $loop->last ? 'border-bottom: none;' : '' }}">
                                    <div style="display: flex; align-items: center; gap: var(--spacing-md);">
                                        <div style="width: 40px; height: 40px; border-radius: var(--radius-md); background: var(--gray-100); display: flex; align-items: center; justify-content: center; color: var(--theme-color);">
                                            <i class="fas fa-file-alt"></i>
                                        </div>
                                        <div>
                                            <div style="font-weight: 600; color: var(--gray-900);">{{ $documento->tipo }}</div>
                                            <div style="font-size: 0.75rem; color: var(--gray-500);">Documento adjunto</div>
                                        </div>
                                    </div>
                                    <a href="{{ asset('storage/' . $documento->ruta_archivo) }}" target="_blank"
                                        class="btn btn-sm btn-outline" style="color: var(--theme-color); border-color: var(--theme-color);">
                ...
                @else
                    <div style="text-align: center; padding: var(--spacing-xl); background: var(--gray-50); border-radius: var(--radius-md); margin-bottom: var(--spacing-xl);">
                        <i class="fas fa-folder-open" style="font-size: 2rem; color: var(--gray-300); margin-bottom: var(--spacing-sm);"></i>
                        <p style="color: var(--gray-500); margin: 0;">No hay documentos cargados aún.</p>
                    </div>
                @endif
                ...
                <div style="padding: var(--spacing-xl); background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: var(--radius-lg); border: 2px dashed var(--gray-300);">
                    <h4 style="font-size: 0.875rem; font-weight: 600; color: var(--gray-700); margin-bottom: var(--spacing-md); text-transform: uppercase; letter-spacing: 0.05em;">
                        <i class="fas fa-plus-circle" style="margin-right: var(--spacing-xs);"></i>
