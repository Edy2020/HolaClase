    ...
    <div class="grid grid-cols-2" style="gap: var(--spacing-xl);">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!-- Giant Grade Display -->
                <div style="text-align: center; padding: var(--spacing-2xl); background: var(--gray-50); border-radius: var(--radius-xl); margin-bottom: var(--spacing-xl);">
                ...
                <dl style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--spacing-md);">
                    <div>
                        <dt style="font-size: 0.75rem; font-weight: 600; color: var(--gray-500); text-transform: uppercase; margin-bottom: 4px;">Tipo Evaluación</dt>
                        <dd style="font-weight: 600; color: var(--gray-900);">{{ $nota->tipo_evaluacion }}</dd>
                    </div>
                    <div>
                        <dt style="font-size: 0.75rem; font-weight: 600; color: var(--gray-500); text-transform: uppercase; margin-bottom: 4px;">Período</dt>
                        <dd style="font-weight: 600; color: var(--gray-900);">{{ $nota->periodo }}</dd>
                    </div>
                    <div>
                        <dt style="font-size: 0.75rem; font-weight: 600; color: var(--gray-500); text-transform: uppercase; margin-bottom: 4px;">Fecha</dt>
                        <dd style="font-weight: 600; color: var(--gray-900);">{{ $nota->fecha ? $nota->fecha->format('d/m/Y') : '–' }}</dd>
                    </div>
                    <div>
                        <dt style="font-size: 0.75rem; font-weight: 600; color: var(--gray-500); text-transform: uppercase; margin-bottom: 4px;">Registrado</dt>
                        <dd style="font-weight: 600; color: var(--gray-900);">{{ $nota->created_at->format('d/m/Y H:i') }}</dd>
                    </div>
                </dl>
        ...
        <div style="display: flex; flex-direction: column; gap: var(--spacing-xl);">
                ...
                <div class="card-body">
                    <div style="display: flex; align-items: center; gap: var(--spacing-md);">
                        ...
                        <div>
                            ...
                            <div style="color: var(--gray-500); font-size: 0.875rem;">{{ $nota->estudiante->rut ?? '' }}</div>
                            <div style="color: var(--gray-500); font-size: 0.875rem;">{{ $nota->estudiante->email ?? '' }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <dl style="display: grid; gap: var(--spacing-md);">
                        <div>
                            <dt style="font-size: 0.75rem; font-weight: 600; color: var(--gray-500); text-transform: uppercase; margin-bottom: 4px;"><i class="fas fa-chalkboard"></i> Curso</dt>
                            <dd style="font-weight: 700; color: var(--gray-900);">{{ $nota->curso->nombre ?? '–' }}</dd>
                        </div>
                        <div>
                            <dt style="font-size: 0.75rem; font-weight: 600; color: var(--gray-500); text-transform: uppercase; margin-bottom: 4px;"><i class="fas fa-book"></i> Asignatura</dt>
                            <dd style="font-weight: 700; color: var(--gray-900);">{{ $nota->asignatura->nombre ?? '–' }}</dd>
                        </div>
                    </dl>
                </div>
            </div>
            ...
            <div style="display: flex; gap: var(--spacing-md);">
                <a href="{{ route('grades.edit', $nota->id) }}" class="btn btn-primary" style="color: white; flex: 1; text-align: center;">
                ...
                <form action="{{ route('grades.destroy', $nota->id) }}" method="POST"
                    ...
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-outline" style="width: 100%; border-color: var(--error); color: var(--error);">
