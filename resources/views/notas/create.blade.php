<x-app-layout>
    ...
    <div class="page-header"
        ...
        <div>
            <h2 style="font-size: 1.5rem; font-weight: 700; color: var(--text-color); margin: 0;">
                <i class="fas fa-clipboard-list" style="color: var(--text-muted); margin-right: 8px;"></i> Registrar
                Notas
            </h2>
    ...
    <div class="mb-xl"
        ...
        <h3
            style="font-size: 1.1rem; font-weight: 700; color: var(--text-color); margin-top: 0; margin-bottom: var(--spacing-md); border-bottom: 1px solid var(--border-color); padding-bottom: var(--spacing-sm);">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2" style="gap: var(--spacing-lg);">
                <div class="form-group mb-0" style="position: relative;">
                    <label class="form-label"
                        style="font-size: 0.85rem; color: var(--text-muted); font-weight: 600;">CURSO *</label>
                    <div
                ...
                <div class="form-group mb-0" style="position: relative;">
                    <label class="form-label"
                        style="font-size: 0.85rem; color: var(--text-muted); font-weight: 600;">ASIGNATURA *</label>
                    <div
                        style="position: absolute; left: 12px; bottom: 10px; color: var(--text-muted); font-size: 1rem; pointer-events: none; z-index: 1;">
    ...
    @if($selectedCurso && $selectedAsignatura && $estudiantes->count() > 0)
        <form action="{{ route('grades.store') }}" method="POST" id="gradesForm">
            ...
            <div class="mb-xl"
                ...
                <h3
                    style="font-size: 1.1rem; font-weight: 700; color: var(--text-color); margin-top: 0; margin-bottom: var(--spacing-md); border-bottom: 1px solid var(--border-color); padding-bottom: var(--spacing-sm);">
                    <i class="fas fa-info-circle" style="color: var(--text-muted); margin-right: 6px;"></i> Detalles de la
                    Evaluación
                </h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4" style="gap: var(--spacing-lg);">
                    <div class="form-group mb-0" style="position: relative;">
                        <label class="form-label"
                            style="font-size: 0.85rem; color: var(--text-muted); font-weight: 600;">TIPO EV. *</label>
                        <div
                            style="position: absolute; left: 12px; bottom: 10px; color: var(--text-muted); font-size: 1rem; pointer-events: none; z-index: 1;">
                    ...
                    <div class="form-group mb-0" style="position: relative;">
                        <label class="form-label"
                            style="font-size: 0.85rem; color: var(--text-muted); font-weight: 600;">PERÍODO *</label>
                        <div
                            style="position: absolute; left: 12px; bottom: 10px; color: var(--text-muted); font-size: 1rem; pointer-events: none; z-index: 1;">
                    ...
                    <div class="form-group mb-0" style="position: relative;">
                        <label class="form-label"
                            style="font-size: 0.85rem; color: var(--text-muted); font-weight: 600;">FECHA *</label>
                        <div
                            style="position: absolute; left: 12px; bottom: 10px; color: var(--text-muted); font-size: 1rem; pointer-events: none; z-index: 1;">
                            <i class="fas fa-calendar"></i>
                        </div>
                        <input type="date" name="fecha" class="form-input" value="{{ date('Y-m-d') }}"
                    ...
                    <div class="form-group mb-0" style="position: relative;">
                        <label class="form-label"
                            style="font-size: 0.85rem; color: var(--text-muted); font-weight: 600;">PONDERACIÓN *</label>
                        <div
                            style="position: absolute; left: 12px; bottom: 10px; color: var(--text-muted); font-size: 1rem; pointer-events: none; z-index: 1;">
                            <i class="fas fa-percent"></i>
                        </div>
                        <input type="number" name="ponderacion" class="form-input" step="1" min="1" max="100" value="30"
                            required
                            style="padding-left: 40px; border: 2px solid var(--border-color); border-radius: var(--radius-lg); transition: all 0.2s; font-size: 0.9375rem; background-color: var(--bg-card); color: var(--text-color);"
                            onfocus="this.style.borderColor='#84cc16'; this.style.boxShadow='0 0 0 3px rgba(132, 204, 22, 0.1)'"
                            onblur="this.style.borderColor='var(--border-color)'; this.style.boxShadow='none'">
            ...
            <div class="card" style="background: var(--bg-card); border: 1px solid var(--border-color);">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" name="notas[{{ $index }}][estudiante_id]"
                                            value="{{ $estudiante->id }}">
                                        <input type="number" name="notas[{{ $index }}][nota]" class="form-input grade-input"
                                            style="width: 100%;" step="0.1" min="1.0" max="7.0" placeholder="1.0 - 7.0"
                                            oninput="validateGrade(this)">
                                    </td>
                                    <td>
                                        <input type="text" name="notas[{{ $index }}][observaciones]" class="form-input"
                                            style="width: 100%;" placeholder="Opcional" maxlength="500">
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                ...
                <div
                    style="margin-top: var(--spacing-lg); padding-top: var(--spacing-lg); border-top: 1px solid var(--border-color); display: flex; justify-content: space-between; align-items: center;">
                    <a href="{{ route('grades.index') }}" class="btn btn-outline"
        ...
        <div style="background: var(--bg-card); border: 1px dashed var(--border-color); border-radius: var(--radius-lg);">
            <div style="text-align: center; padding: var(--spacing-2xl);">
                <i class="fas fa-users-slash"
                    style="font-size: 3rem; color: var(--text-muted); margin-bottom: var(--spacing-md); opacity: 0.8;"></i>
                <p style="color: var(--text-color); margin: 0; font-weight: 500;">No hay estudiantes inscritos en este curso
                ...
                <a href="{{ route('courses.show', $selectedCurso->id) }}" class="btn btn-primary"
        ...
        <div style="background: var(--bg-card); border: 1px dashed var(--border-color); border-radius: var(--radius-lg);">
            <div style="text-align: center; padding: var(--spacing-2xl);">
                <i class="fas fa-hand-pointer"
                    style="font-size: 3rem; color: var(--text-muted); margin-bottom: var(--spacing-md); opacity: 0.8;"></i>
                <p style="color: var(--text-color); margin: 0; font-weight: 500;">Selecciona un curso y una asignatura para
                    comenzar a registrar notas</p>
            </div>
        </div>
    @endif
