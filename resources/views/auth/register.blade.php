<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div style="display: flex; flex-direction: column; gap: var(--spacing-md); margin-top: var(--spacing-xl);">
            ...
            <div
                style="text-align: center; padding-top: var(--spacing-md); border-top: 1px solid var(--gray-200); color: var(--gray-600); font-size: 0.875rem;">
                ¿Ya tienes cuenta?
                <a href="{{ route('login') }}"
                    style="color: var(--theme-color); text-decoration: none; font-weight: 600;">
                    Inicia sesión aquí
                </a>
            </div>
        </div>
