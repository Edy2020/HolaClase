<x-app-layout>
    ...
    <div class="mobile-cards" style="display: none;">
        @forelse($cursos as $curso)
            <div class="card mb-md" style="cursor: pointer;" onclick="window.location='{{ route('courses.show', $curso->id) }}'">
    ...
    <div class="table-container">
        <table class="table">
            ...
            <tbody>
                @forelse($cursos as $curso)
                    <tr style="cursor: pointer;" onclick="window.location='{{ route('courses.show', $curso->id) }}'">
                        <td>
